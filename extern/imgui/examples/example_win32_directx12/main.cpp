...
int main(int, char**)
{
    ...
    //io.Fonts->AddFontFromFileTTF("../../misc/font/DroidSans.ttf");
    //io.Fonts->AddFontFromFileTTF("../../misc/font/Roboto-Medium.ttf");
    //io.Fonts->AddFontFromFileTTF("../../misc/font/Cousine-Regular.ttf");
